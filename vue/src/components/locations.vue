  ...
  <div>
    <div id="grid-container">
      <div id="intro">
         ...
         Type the name of a brewery to see it on a map or right click on the map to see breweries near the location. 
          <ol>
           
           <li>Right click on the map, and enter a description when prompted</li> 
           <li> MapService.js using breweries data .</li>
          </ol>
      </div>
...
export default {
  ...
  data() {
    return {
      map: null,
      mapCenter: { lat: 49.3327, lng: -83.0458 },
      locations: [
